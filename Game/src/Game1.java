...
public class Game1 extends Canvas {
	...
	public Game1() {
		...
		JFrame container = new JFrame("Alien Wars-Level 2");
	...
	private void initEntities() {
		...
		ship = new ShipEntity1(this,"sprites/ship.gif",370,550);
		entities.add(ship);
		...
		for (int row=0;row<6;row++) {
			for (int x=0;x<12;x++) {
				Entity1 alien = new AlienEntity1(this,"sprites/alien.gif",100+(x*50),(50)+row*30);
				entities.add(alien);
				alienCount++;
			}
		}
	 ...
	 */
	public void removeEntity(Entity1 entity) {
	...
	public void notifyWin() {
		message = "Well done! You defeated the second attack of aliens! Press any key to proceed to next level!";
		waitingForKeyPress = true;
                Game2 g2 = new Game2();
                g2.gameLoop();
	...
	public void notifyAlienKilled() {
		...
		for (int i=0;i<entities.size();i++) {
			Entity1 entity = (Entity1) entities.get(i);

			if (entity instanceof AlienEntity1) {
				// speed up by 2%
	...
	public void tryToFire() {
		...
		ShotEntity1 shot = new ShotEntity1(this,"sprites/shot.gif",ship.getX()+10,ship.getY()-30);
		entities.add(shot);
	}
		...
		while (gameRunning) {
			...
			for (int p=0;p<entities.size();p++) {
				for (int s=p+1;s<entities.size();s++) {
					Entity1 me = (Entity1) entities.get(p);
					Entity1 him = (Entity1) entities.get(s);
