 ...
 * @author Divyanshu
 */
public class Game4 extends Canvas {
	...
	public Game4() {
		...
		JFrame container = new JFrame("Alien Wars-Level 5");
	...
	private void initEntities() {
		...
		ship = new ShipEntity4(this,"sprites/ship1.gif",370,550);
		entities.add(ship);
		...
		for (int row=0;row<7;row++) {
			for (int x=0;x<12;x++) {
				Entity4 alien = new AlienEntity4(this,"sprites/alien.gif",100+(x*50),(50)+row*30);
				entities.add(alien);
				alienCount++;
			}
		}
	 ...
	 */
	public void removeEntity(Entity4 entity) {
	...
	public void notifyAlienKilled() {
		...
		for (int i=0;i<entities.size();i++) {
			Entity4 entity = (Entity4) entities.get(i);

			if (entity instanceof AlienEntity4) {
				// speed up by 4%
	...
	public void tryToFire() {
		...
		ShotEntity4 shot = new ShotEntity4(this,"sprites/shot.gif",ship.getX()+10,ship.getY()-30);
		entities.add(shot);
	}
		...
		while (gameRunning) {
			...
			for (int p=0;p<entities.size();p++) {
				for (int s=p+1;s<entities.size();s++) {
					Entity4 me = (Entity4) entities.get(p);
					Entity4 him = (Entity4) entities.get(s);
