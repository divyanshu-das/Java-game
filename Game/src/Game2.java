...
public class Game2 extends Canvas {
	...
	public Game2() {
		...
		JFrame container = new JFrame("Alien Wars-Level 3");
	...
	private void initEntities() {
		...
		ship = new ShipEntity2(this,"sprites/ship.gif",370,550);
		entities.add(ship);
		...
		for (int row=0;row<7;row++) {
			for (int x=0;x<12;x++) {
				Entity2 alien = new AlienEntity2(this,"sprites/alien.gif",100+(x*50),(50)+row*30);
				entities.add(alien);
				alienCount++;
			}
		}
	 ...
	 */
	public void removeEntity(Entity2 entity) {
	...
	public void notifyWin() {
		message = "Well done!You defeated the third attack of aliens! Press any key to proceed to next level!";
		waitingForKeyPress = true;
                Game3 g3 = new Game3();
                g3.gameLoop();
	...
	public void notifyAlienKilled() {
		...
		for (int i=0;i<entities.size();i++) {
			Entity2 entity = (Entity2) entities.get(i);

			if (entity instanceof AlienEntity2) {
				// speed up by 2%
	...
	public void tryToFire() {
		...
		ShotEntity2 shot = new ShotEntity2(this,"sprites/shot.gif",ship.getX()+10,ship.getY()-30);
		entities.add(shot);
	}
		...
		while (gameRunning) {
			...
			for (int p=0;p<entities.size();p++) {
				for (int s=p+1;s<entities.size();s++) {
					Entity2 me = (Entity2) entities.get(p);
					Entity2 him = (Entity2) entities.get(s);
