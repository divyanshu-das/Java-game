 ...
 * @author Divyanshu
 */
public class SpriteStore2 {
	/** The single instance of this class */
	private static SpriteStore2 single = new SpriteStore2();
	 ...
	 */
	public static SpriteStore2 get() {
		return single;
	}
	 ...
	 */
	public Sprite2 getSprite(String ref) {
		// if we've already got the sprite in the cache
		// then just return the existing version
		if (sprites.get(ref) != null) {
			return (Sprite2) sprites.get(ref);
		}
		...
		Sprite2 sprite = new Sprite2(image);
