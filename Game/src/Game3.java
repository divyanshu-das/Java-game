 ...
 * @author Divyanshu
 */
public class Game3 extends Canvas {
	...
	public Game3() {
		...
		JFrame container = new JFrame("Alien Wars-Level 4");
	...
	private void initEntities() {
		...
		ship = new ShipEntity3(this,"sprites/ship1.gif",370,550);
		entities.add(ship);
		...
		for (int row=0;row<8;row++) {
			for (int x=0;x<12;x++) {
				Entity3 alien = new AlienEntity3(this,"sprites/alien.gif",100+(x*50),(50)+row*30);
				entities.add(alien);
				alienCount++;
			}
		}
	 ...
	 */
	public void removeEntity(Entity3 entity) {
	...
	public void notifyWin() {
		message = "Well done!You defeated the fourth attack of aliens! Press any key to proceed to next level!";
		waitingForKeyPress = true;
                Game4 g4 = new Game4();
                g4.gameLoop();
	...
	public void notifyAlienKilled() {
		...
		for (int i=0;i<entities.size();i++) {
			Entity3 entity = (Entity3) entities.get(i);

			if (entity instanceof AlienEntity3) {
				// speed up by 2%
	...
	public void tryToFire() {
		...
		ShotEntity3 shot = new ShotEntity3(this,"sprites/shot.gif",ship.getX()+10,ship.getY()-30);
		entities.add(shot);
	}
		...
		while (gameRunning) {
			...
			for (int p=0;p<entities.size();p++) {
				for (int s=p+1;s<entities.size();s++) {
					Entity3 me = (Entity3) entities.get(p);
					Entity3 him = (Entity3) entities.get(s);
