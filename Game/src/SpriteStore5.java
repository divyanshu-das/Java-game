 ...
 * @author Divyanshu
 */
public class SpriteStore5 {
	/** The single instance of this class */
	private static SpriteStore5 single = new SpriteStore5();
	 ...
	 */
	public static SpriteStore5 get() {
		return single;
	}
	 ...
	 */
	public Sprite5 getSprite(String ref) {
		// if we've already got the sprite in the cache
		// then just return the existing version
		if (sprites.get(ref) != null) {
			return (Sprite5) sprites.get(ref);
		}
		...
		Sprite5 sprite = new Sprite5(image);
