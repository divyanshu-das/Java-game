...
public class Game extends Canvas {
	...
	public Game() {
		...
		JFrame container = new JFrame("Alien Wars-Level 1");
	...
	public void notifyWin() {
		message = "Well done! You defeated the first attack of aliens! Press any key to proceed to next level!";
		waitingForKeyPress = true;
                Game1 g1 = new Game1();
                g1.gameLoop();
	...
	public void gameLoop() {
		...
		while (gameRunning) {
			...
			if (waitingForKeyPress) {
				...
				g.drawString("Press any key to start.",(800-g.getFontMetrics().stringWidth("Press any key"))/2,300);
			}
	 ...
	 * continue)
	 *
	 * This has been implemented as an inner class.
	 * This can be implemented as separate class if slight less convenient.
	 *
	 * @author Divyanshu
	 */
