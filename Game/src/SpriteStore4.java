 ...
 * @author Divyanshu
 */
public class SpriteStore4 {
	/** The single instance of this class */
	private static SpriteStore4 single = new SpriteStore4();
	 ...
	 */
	public static SpriteStore4 get() {
		return single;
	}
	 ...
	 */
	public Sprite4 getSprite(String ref) {
		// if we've already got the sprite in the cache
		// then just return the existing version
		if (sprites.get(ref) != null) {
			return (Sprite4) sprites.get(ref);
		}
		...
		Sprite4 sprite = new Sprite4(image);
