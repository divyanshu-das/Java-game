 ...
 * @author Divyanshu
 */
public class SpriteStore1 {
	/** The single instance of this class */
	private static SpriteStore1 single = new SpriteStore1();
	 ...
	 */
	public static SpriteStore1 get() {
		return single;
	}
	 ...
	 */
	public Sprite1 getSprite(String ref) {
		// if we've already got the sprite in the cache
		// then just return the existing version
		if (sprites.get(ref) != null) {
			return (Sprite1) sprites.get(ref);
		}
		...
		Sprite1 sprite = new Sprite1(image);
