 ...
 * @author Divyanshu
 */
public class SpriteStore3 {
	/** The single instance of this class */
	private static SpriteStore3 single = new SpriteStore3();
	 ...
	 */
	public static SpriteStore3 get() {
		return single;
	}
	 ...
	 */
	public Sprite3 getSprite(String ref) {
		// if we've already got the sprite in the cache
		// then just return the existing version
		if (sprites.get(ref) != null) {
			return (Sprite3) sprites.get(ref);
		}
		...
		Sprite3 sprite = new Sprite3(image);
